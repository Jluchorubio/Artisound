...
export default function RebelHeader({ user, onLogout }) {
  ...
  useEffect(() => {
    ...
    const startHeight = menu.offsetHeight || menu.scrollHeight;
    if (!startHeight) {
  ...
  return (
    <header className="sticky top-0 z-40 border-b-4 border-yellow-400 bg-black px-4 py-4 md:px-8">
      ...
      <div ref={mobileMenuRef} style={{ display: 'none' }} className="mx-auto mt-3 w-full max-w-7xl space-y-2 border border-white/10 bg-black/80 p-3 md:hidden">
